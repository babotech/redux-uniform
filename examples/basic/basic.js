...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Forms = __webpack_require__(105);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.reducer = exports.uniform = exports.FieldTypes = undefined;

	var _fieldCreators = __webpack_require__(126);

	var _fieldCreators2 = _interopRequireDefault(_fieldCreators);

	var _connectForm = __webpack_require__(117);

	var _connectForm2 = _interopRequireDefault(_connectForm);

	var _formReducer = __webpack_require__(130);
...
/***/ function(module, exports) {
	...
	var INIT_STATE = exports.INIT_STATE = "REDUX-STATE/INIT_STATE";
	var REMOVE_STATE = exports.REMOVE_STATE = "REDUX-STATE/REMOVE_STATE";
	var UPDATE_STATY = exports.UPDATE_STATY = "REDUX-STATE/UPDATE_STATY";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Input = function Input(props) {
	    ...
	    return _react2.default.createElement('input', _extends({ style: style }, props));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createOnBlur = __webpack_require__(120);

	var _createOnBlur2 = _interopRequireDefault(_createOnBlur);

	var _createOnChange = __webpack_require__(121);

	var _createOnChange2 = _interopRequireDefault(_createOnChange);

	var _createOnFocus = __webpack_require__(122);
	...
	var validate = function validate(options, value) {
	    var execValidate = options && options.validate ? options.validate : options;
	    ...
	    if (typeof execValidate === 'function') {
	        ...
	        try {
	            for (var _iterator = execValidate[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	var fieldType = function fieldType(options) {
	    return function (fieldPath) {
	        var fieldsPath = arguments.length <= 1 || arguments[1] === undefined ? [] : arguments[1];
	        var state = arguments.length <= 2 || arguments[2] === undefined ? (0, _immutable.Map)() : arguments[2];
	        var props = arguments.length <= 3 || arguments[3] === undefined ? {} : arguments[3];

	        var focused = (0, _immutable.is)((0, _immutable.List)(fieldPath), state.get('focusedFieldPath'));
	        var fieldState = state.getIn([].concat(_toConsumableArray(fieldsPath), _toConsumableArray(fieldPath)));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var composeSwitch = function composeSwitch(accumulator, switchField) {
	    for (var predictor in switchField) {
	...
	var mapType = function mapType(fields) {
	    return function (fieldPath, fieldsPath, state, props) {
	        return Object.keys(fields).reduce(function (acc, key) {
	            ...
	            var field = fieldCreator([].concat(_toConsumableArray(fieldPath), ['map', key]), fieldsPath, state, props);
	            return acc.setIn(['map', key], field).update('valid', function (v) {
	                var valid = v && field.get('valid');
...
/***/ function(module, exports) {
	...
	var INITIALIZE = exports.INITIALIZE = "@@UNIFORM/COMPONENTS_FORM_INITIALIZE";
	var CHANGE = exports.CHANGE = "@@UNIFORM/COMPONENTS_FORM_CHANGE";
	var SWITCH_CHANGE = exports.SWITCH_CHANGE = "@@UNIFORM/COMPONENTS_FORM_SWITCH_CHANGE";
	var VALIDATE = exports.VALIDATE = "@@UNIFORM/COMPONENTS_FORM_VALIDATE";
	var START_VALIDATION = exports.START_VALIDATION = "@@UNIFORM/COMPONENTS_FORM_START_VALIDATION";
	var END_VALIDATION = exports.END_VALIDATION = "@@UNIFORM/COMPONENTS_FORM_END_VALIDATION";
	var REMOVE = exports.REMOVE = "@@UNIFORM/COMPONENTS_FORM_REMOVE";
	var ADD = exports.ADD = "@@UNIFORM/COMPONENTS_FORM_ADD";
	var CHANGE_CARET_POSITION = exports.CHANGE_CARET_POSITION = "@@UNIFORM/COMPONENTS_FORM_CHANGE_CARET_POSITION";
	var FOCUS = exports.FOCUS = "@@UNIFORM/COMPONENTS_FORM_FOCUS";
	var BLUR = exports.BLUR = "@@UNIFORM/COMPONENTS_FORM_BLUR";
	var START_SUBMITTING = exports.START_SUBMITTING = "@@UNIFORM/COMPONENTS_FORM_START_SUBMITTING";
	var END_SUBMITTING = exports.END_SUBMITTING = "@@UNIFORM/COMPONENTS_FORM_END_SUBMITTING";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isEvent = __webpack_require__(125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nextStateId = __webpack_require__(215);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.staty = exports.reducer = exports.connectState = undefined;

	var _connectState = __webpack_require__(98);

	var _connectState2 = _interopRequireDefault(_connectState);

	var _statesReducer = __webpack_require__(217);

	var _statesReducer2 = _interopRequireDefault(_statesReducer);

	var _staty = __webpack_require__(218);

	var _staty2 = _interopRequireDefault(_staty);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

	exports.connectState = _connectState2["default"];
	exports.reducer = _statesReducer2["default"];
	exports.staty = _staty2["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Submit = __webpack_require__(107);
	...
	var _shortUserList = __webpack_require__(113);

	var _shortUserList2 = _interopRequireDefault(_shortUserList);

	var _fullUserList = __webpack_require__(112);

	var _fullUserList2 = _interopRequireDefault(_fullUserList);

	var _required = __webpack_require__(114);
	...
	var Form = function Form(_ref) {
	    ...
	    var submitAllowed = _ref.submitAllowed;
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'div',
	            { style: values },
	            _react2.default.createElement(_Values2.default, { getValues: getValues })
	        )
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Forms = function (_Component) {
	    ...
	    function Forms() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Forms).call(this));
	    ...
	    _createClass(Forms, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { style: container },
	                Array.apply(undefined, _toConsumableArray(Array(count))).map(function (_, i) {
	                    return _react2.default.createElement(
	                        'div',
	                        { key: i, style: form },
	                        _react2.default.createElement(_Form2.default, { initialValue: initialValue })
	                    );
	                }),
	                _react2.default.createElement(
	                    'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Submit = function Submit(_ref) {
	    ...
	    var onClick = function onClick() {
	        return handleSubmit(function (data) {
	            return new Promise(function (resolve, reject) {
	                return confirm(JSON.stringify(data, undefined, 4)) ? resolve() : reject();
	            });
	        });
	    };
	    ...
	    return _react2.default.createElement(
	        'button',
	        { disabled: !submitAllowed, style: style, onClick: onClick },
	        'Submit'
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Short = __webpack_require__(110);

	var _Short2 = _interopRequireDefault(_Short);

	var _Full = __webpack_require__(109);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var realWomanList = _lib.FieldTypes.list(_lib.FieldTypes.map({
	    firstName: _lib.FieldTypes.field(),
	    lastName: _lib.FieldTypes.field()
	}), validation);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxLogger = __webpack_require__(213);
	...
	var logger = (0, _reduxLogger2.default)({
	    stateTransformer: function stateTransformer(state) {
	        return Object.keys(state.states).reduce(function (acc, key) {
	            var _state$states$key = state.states[key];
	            var localState = _state$states$key.state;

	            var rest = _objectWithoutProperties(_state$states$key, ['state']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formActions = __webpack_require__(129);
	...
	var _composeFields = __webpack_require__(116);

	var _composeFields2 = _interopRequireDefault(_composeFields);

	var _reduxState = __webpack_require__(99);

	var _extractValues = __webpack_require__(118);

	var _extractValues2 = _interopRequireDefault(_extractValues);

	var _reducer = __webpack_require__(131);
	...
	var createFormProps = function createFormProps(fields, inst) {
	    ...
	    return function (Target) {
	        var ConnectForm = function (_Component) {
	            ...
	            function ConnectForm() {
	                ...
	                return _possibleConstructorReturn(this, Object.getPrototypeOf(ConnectForm).apply(this, arguments));
	            }
	        ...
	        return (0, _reduxState.connectState)(mapStateToProps, mapDispatchToProps, undefined, _reducer2.default, false)(ConnectForm);
	    };
	};
...
/***/ function(module, exports) {
	...
	var extractValue = function extractValue(field) {
	    return field.has("list") ? field.get("list").map(function (i) {
	        return i.has("value") ? i.get("value") : extractValue(i);
	    }) : field.has("map") ? field.get("map").map(extractValue) : field.get("value");
	};
...
/***/ function(module, exports) {
	...
	var createAddField = function createAddField(fieldPath, addField) {
	    return function (data, index, focused) {
	        return addField(fieldPath, data, index, focused);
	    };
	};
...
/***/ function(module, exports) {
	...
	var createOnFocus = function createOnFocus(fieldPath, focus) {
	    return function () {
...
/***/ function(module, exports) {
	...
	var createRemoveField = function createRemoveField(fieldPath, removeField) {
	    return function (index) {
	        return removeField(fieldPath, index);
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fieldType = __webpack_require__(37);

	var _fieldType2 = _interopRequireDefault(_fieldType);

	var _listType = __webpack_require__(127);

	var _listType2 = _interopRequireDefault(_listType);

	var _mapType = __webpack_require__(38);

	var _mapType2 = _interopRequireDefault(_mapType);

	var _switchType = __webpack_require__(128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createAddField = __webpack_require__(119);

	var _createAddField2 = _interopRequireDefault(_createAddField);

	var _createRemoveField = __webpack_require__(123);

	var _createRemoveField2 = _interopRequireDefault(_createRemoveField);
	...
	var list = (0, _immutable.Map)({
	    list: (0, _immutable.List)(),
	    valid: true,
	    validating: false
	});

	var validate = function validate(options, items) {
	    if (typeof options === 'function') {
	        var execValidate = options;
	...
	var listType = function listType() {
	    ...
	    return function (fieldPath) {
	        ...
	        }, list).update(function (l) {
	            return l.update('valid', function (v) {
	                return v && validate(options, l.get('list'));
	            });
	        }).merge(listMethods);
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createSwitchOnChange = __webpack_require__(124);

	var _createSwitchOnChange2 = _interopRequireDefault(_createSwitchOnChange);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.submit = exports.blur = exports.focus = exports.changeCaretPosition = exports.removeField = exports.addField = exports.validate = exports.switchChange = exports.change = exports.initialize = undefined;

	var _actionTypes = __webpack_require__(59);

	var _transformToState = __webpack_require__(132);
	...
	var change = exports.change = function change(fieldPath, value) {
	    return {
	...
	var switchChange = exports.switchChange = function switchChange(fieldPath, value, deps) {
	    return {
	        type: _actionTypes.SWITCH_CHANGE,
	        result: {
	            fieldPath: fieldPath,
	            value: value,
	            deps: deps
	...
	var validate = exports.validate = function validate(fieldPath, value) {

	    if (value && typeof value.then === 'function') {
	        return function (dispatch) {
	            dispatch({
	                type: _actionTypes.START_VALIDATION,
	                result: {
	                    fieldPath: fieldPath
	                }
	            });
	            value.then(function (result) {
	                return dispatch({
	                    type: _actionTypes.END_VALIDATION,
	                    result: {
	                        fieldPath: fieldPath,
	                        value: result
	                    }
	...
	var addField = exports.addField = function addField(fieldPath, data, index) {
	...
	var removeField = exports.removeField = function removeField(fieldPath, index) {
	    return {
	...
	var changeCaretPosition = exports.changeCaretPosition = function changeCaretPosition(fieldPath, caretPosition) {
	    return {
	        type: _actionTypes.CHANGE_CARET_POSITION,
	        result: {
	            fieldPath: fieldPath,
	...
	var focus = exports.focus = function focus(fieldPath) {
	    return {
	...
	var submit = exports.submit = function submit(promise) {
	    return function (dispatch) {
	        dispatch({
	            type: _actionTypes.START_SUBMITTING
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var formReducer = function formReducer() {
	    ...
	    switch (action.type) {
	        ...
	        case _actionTypes.SWITCH_CHANGE:
	            {
	                state = state.setIn(['fields'].concat(_toConsumableArray(action.result.fieldPath), ['value']), action.result.value);

	                var fieldPathSkipLast = action.result.fieldPath.slice(0, -1);
	        ...
	        case _actionTypes.VALIDATE:
	            return state.setIn(['fields'].concat(_toConsumableArray(action.result.fieldPath), ['valid']), action.result.value);
	        case _actionTypes.START_VALIDATION:
	            return state.setIn(['fields'].concat(_toConsumableArray(action.result.fieldPath), ['validating']), true);
	        case _actionTypes.END_VALIDATION:
	            return state.updateIn(['fields'].concat(_toConsumableArray(action.result.fieldPath)), function (field) {
	                return field.withMutations(function (f) {
	                    return f.set('validating', false).set('valid', action.result.value);
	                });
	            });
	        case _actionTypes.REMOVE:
	            return state.removeIn(['fields'].concat(_toConsumableArray(action.result.fieldPath), ['list', action.result.index]));
	        case _actionTypes.ADD:
	            {
	                state = state.updateIn(['fields'].concat(_toConsumableArray(action.result.fieldPath), ['list']), function () {
	                    var list = arguments.length <= 0 || arguments[0] === undefined ? (0, _immutable.List)() : arguments[0];
	                    return typeof action.result.index === 'undefined' ? list.push(action.result.data) : list.splice(action.result.index, 0, action.result.data);
	                });

	                if (action.result.focused) {
	                    state = state.set('focusedFieldPath', (0, _immutable.List)([].concat(_toConsumableArray(action.result.fieldPath), ['list', typeof action.result.index === 'undefined' ? state.getIn(['fields'].concat(_toConsumableArray(action.result.fieldPath))).size - 1 : action.result.index])));
	                }
	                return state;
	            }
	        case _actionTypes.FOCUS:
	            return state.set('focusedFieldPath', (0, _immutable.List)(action.result.fieldPath));
	        case _actionTypes.CHANGE_CARET_POSITION:
	            return state.withMutations(function (s) {
	                return s.set('focusedFieldPath', (0, _immutable.List)(action.result.fieldPath)).set('caretPosition', (0, _immutable.List)(action.result.caretPosition));
	            });
	        case _actionTypes.BLUR:
	            return state.withMutations(function (s) {
	                return s.set('focusedFieldPath', (0, _immutable.List)()).set('caretPosition', (0, _immutable.List)());
	            });
	        case _actionTypes.START_SUBMITTING:
	            return state.set('submitting', true);
	        case _actionTypes.END_SUBMITTING:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapState = (0, _immutable.Map)({
	    map: (0, _immutable.Map)({})
	});

	var createFieldState = function createFieldState(value) {
	...
	var transformImmutable = function transformImmutable(data) {
	    return data.reduce(function (acc, value, key) {
	        return _immutable.List.isList(value) ? acc.setIn(['map', key, 'list'], (0, _immutable.List)(value.map(function (item) {
	            return transformToState(item);
	        }))) : acc.setIn(['map', key], transformToState(value));
	    }, mapState);
	};

	var isObject = function isObject(candidate) {
	    return (typeof candidate === 'undefined' ? 'undefined' : _typeof(candidate)) === 'object' && candidate !== null;
	};

	var transformPlainObject = function transformPlainObject(data) {
	    return Object.keys(data).reduce(function (acc, key) {
	        return Array.isArray(data[key]) ? acc.setIn(['map', key, 'list'], (0, _immutable.List)(data[key].map(function (item) {
	            return transformToState(item);
	        }))) : acc.setIn(['map', key], transformToState(data[key]));
	    }, mapState);
	};

	var transformToState = function transformToState(data) {
	    return _immutable.Iterable.isIterable(data) ? transformImmutable(data) : isObject(data) ? transformPlainObject(data) : createFieldState(data);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wrapActionCreators = __webpack_require__(152);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(153),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.updateStaty = exports.removeState = exports.initState = undefined;

	var _actionTypes = __webpack_require__(35);

	var initState = exports.initState = function initState(stateId, stateReducer) {
	    return {
	...
	var removeState = exports.removeState = function removeState(stateId) {
	    return {
	        type: _actionTypes.REMOVE_STATE,
	        payload: {
	            stateId: stateId
	        }
	    };
	...
	var updateStaty = exports.updateStaty = function updateStaty(state) {
	    return {
	        type: _actionTypes.UPDATE_STATY,
	        payload: {
	            state: state
	        }
	    };
...
/***/ function(module, exports) {
	...
	var stateId = 0;
	var nextStateId = function nextStateId() {
	  return stateId++;
	};
	exports["default"] = nextStateId;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.stateIdPropType = exports.storePropType = undefined;

	var _react = __webpack_require__(5);

	var storePropType = exports.storePropType = _react.PropTypes.object;
	var stateIdPropType = exports.stateIdPropType = _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var statesReducer = function statesReducer() {
	    ...
	    if (typeof action.stateId !== 'undefined') {
	        var stateToUpdate = state[action.stateId];

	        var restStates = _objectWithoutProperties(state, [action.stateId]);

	        var stateOfStateToUpdate = stateToUpdate.state;

	        var restOfStateToUpdate = _objectWithoutProperties(stateToUpdate, ['state']);

	        return _extends({}, restStates, _defineProperty({}, action.stateId, _extends({}, restOfStateToUpdate, {
	            state: stateToUpdate.stateReducer(stateOfStateToUpdate, action)
	        })));
	    }

	    return Object.keys(state).reduce(function (updatedStates, stateId) {
	        var stateToUpdate = updatedStates[stateId];

	        var restStates = _objectWithoutProperties(updatedStates, [stateId]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _statyReducer = __webpack_require__(219);

	var _statyReducer2 = _interopRequireDefault(_statyReducer);
	...
	var staty = function staty(WrappedComponent) {
	    return (0, _connectState2["default"])(mapStateToProps, mapDispatchToProps, undefined, _statyReducer2["default"])(WrappedComponent);
	};

	exports["default"] = staty;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var statyReducer = function statyReducer() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	    var action = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	    if (action.type === _actionTypes.UPDATE_STATY) {
